(function () {
  ...
  new Schema({nodes: nodes, marks: marks});
  ...
  var rngBrowserExports = {};
  var rngBrowser = {
    get exports(){ return rngBrowserExports; },
    set exports(v){ rngBrowserExports = v; },
  };
  ...
  const setNoteMeta$1 = (key) => (id, meta) =>
    setNotesMeta(key)([
